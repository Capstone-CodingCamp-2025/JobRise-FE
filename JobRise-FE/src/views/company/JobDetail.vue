<template>
  <div class="py-6 px-4 md:py-10 md:px-16">
    <div class="flex flex-col md:flex-row justify-between w-full mb-6 md:mb-0">
      <div class="flex w-full gap-x-6 md:gap-x-10 mb-4 md:mb-0 justify-center md:justify-start">
        <div
          class="w-20 h-20 md:w-28 md:h-28 bg-amber-300 rounded-sm flex-shrink-0"
        ></div>
        <div class="pt-1 md:pt-3">
          <p class="font-bold text-lg md:text-xl">Position</p>
          <p class="font-medium text-gray-600 text-sm md:text-base">Company</p>
        </div>
      </div>
      ...
      <div class="flex justify-between gap-x-2 md:gap-x-3 pt-2 md:pt-5">
        ...
        >
        <span
          class="bg-slate-200 text-green-500 h-max px-4 py-1 rounded-sm text-sm md:text-base"
          >Active</span
        >
      </div>
    </div>
    ...
    >
      <div class="px-6 py-4 md:px-10 md:py-8 w-full outline outline-gray-300">
        ...
        <p class="text-green-400 font-medium text-sm md:text-base">xxx - xxx</p>
      </div>
      <div class="px-6 py-4 md:px-10 md:py-8 w-full outline outline-gray-300">
      ...
      <div class="px-6 py-4 md:px-10 md:py-8 w-full outline outline-gray-300">
        ...
        <p class="text-gray-600 font-medium text-sm md:text-base">Full-Time</p>
      </div>
    </div>
