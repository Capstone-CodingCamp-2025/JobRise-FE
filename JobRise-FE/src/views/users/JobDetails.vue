<template>
  <div class="py-6 px-4 md:py-10 md:px-16 relative">
    <router-link :to="{ name: 'find-job' }" class="absolute right-4 top-2 md:right-10 md:top-3">
      <Icon
    ...
    <div class="flex flex-col md:flex-row justify-between w-full mb-4 md:mb-0">
      ...
      <div class="flex pt-2 md:pt-5 gap-x-2 md:gap-x-4">
        ...
        <router-link
          to=""
          class="bg-blue-950/80 text-white w-28 md:w-38 py-1.5 md:pt-2 text-center h-8 md:h-10 relative rounded-md pr-3 md:pr-5 text-xs md:text-sm"
        >
          Apply Now
          <Icon
