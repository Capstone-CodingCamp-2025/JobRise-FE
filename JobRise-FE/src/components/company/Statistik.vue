<template>
  <div class="px-4 md:px-8 lg:px-12">
    ...
    <div class="flex gap-x-2">
      <div
        class="bg-[#F1F4FA] w-max  rounded-lg outline px-10 md:px-22 lg:px-32 place-items-center text-justify py-2 md:py-6"
      >
      ...
      >
        ...
        <p class="text-md font-semibold text-slate-700">candidates</p>
      </div>
    </div>
  </div>
</template>
